...
--- image/decoders/nsJPEGDecoder.cpp.orig	2017-06-15 20:52:37.000000000 +0000
...
@@ -350,6 +365,7 @@ nsJPEGDecoder::ReadJPEGData(const char* 
         case JCS_GRAYSCALE:
         case JCS_RGB:
         case JCS_YCbCr:
+#ifdef JCS_EXTENSIONS
...
@@ -358,6 +374,9 @@ nsJPEGDecoder::ReadJPEGData(const char* 
           } else {
...
+#endif
         ...
         case JCS_CMYK:
         case JCS_YCCK:
@@ -432,6 +451,16 @@ nsJPEGDecoder::ReadJPEGData(const char* 
